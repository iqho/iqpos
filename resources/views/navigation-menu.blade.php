<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('admin.users.show') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Users List') }}
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('admin.users.show') }}" :active="request()->routeIs('dashboard')">
                {{ __('Users List') }}
            </x-jet-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                @if(Auth::user()->utype === 'admin')
                <x-jet-responsive-nav-link href="{{ route('admin.profile.show') }}"
